...
public class GestorNiveles : MonoBehaviour
{
    ...
    public void CargarNivel(int indice)
    {
        if (indice < niveles.Count)
        {
            ...
            {
                nivelEnEscena.AsignarNivel(niveles[nivelActual].nombre, niveles[nivelActual].objetivo, niveles[nivelActual].prefabToSpawn, niveles[nivelActual].bloquesDisponibles);
            }
